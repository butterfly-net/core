...
group = "it.unibz.butterfly_net.core.agent_manager"
version = "1.0-SNAPSHOT"

tasks.withType<ShadowJar> {
    archiveFileName = "${project.group}_${project.version}_shadow.jar"
    manifest {
        attributes["Main-Class"] = "${project.group}.Component"
    }
}
